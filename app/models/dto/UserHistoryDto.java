...
public class UserHistoryDto {
	...
	private TypeDate startTime, lastEvent, lastForumView, lastLesson;
	...
	public TypeDate getStartTime() {
		return startTime;
	}
	public void setStartTime(TypeDate startTime) {
		this.startTime = startTime;
	}
	public TypeDate getLastEvent() {
		return lastEvent;
	}
	public void setLastEvent(TypeDate lastEvent) {
		this.lastEvent = lastEvent;
	}
	public TypeDate getLastForumView() {
		return lastForumView;
	}
	public void setLastForumView(TypeDate lastForumView) {
		this.lastForumView = lastForumView;
	}
	public TypeDate getLastLesson() {
		return lastLesson;
	}
	public void setLastLesson(TypeDate lastLesson) {
