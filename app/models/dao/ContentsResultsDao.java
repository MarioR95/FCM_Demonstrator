...
public class ContentsResultsDao {
	...
	public static boolean isQuizCompleted(String courseId, String userId, String contentType, String topic) throws ConfigurationException, Exception {
		...
		try {
			   ...
			   ContentsResultsDto quiz = qRunner.query(conn, FileQueryReader.getQuery("CONTENTS_RESULTS_S02"),
					   new TrimmedBeanHandler<ContentsResultsDto>(ContentsResultsDto.class),
					   new Object[]{courseId,userId,contentType,topic});
