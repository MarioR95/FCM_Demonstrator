																...
																<table class="table">
																	...
																	<tbody>
																			...
																			<td>
																				<div class='dropdown dropright'>
																					...
																					<div class='dropdown-menu dropdown-menu-left' x-placement='top-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);'>
																						<a class='dropdown-item' href='#'><i class="fas fa-book-reader"></i>Learn</a>
																						<!--  <a class='dropdown-item' href='#'><i class="fas fa-qrcode"></i> Go to Quiz</a>-->
																					</div>
																				</div>
																			</td>
																		</tr>
																		...
																		<tr>
																			<td>
																				<div class="kt-widget4__pic kt-widget4__pic--icon">
																					<img src="assets/images/files/exam.svg" alt="" style="height: 45px; width: 45px">
																				</div>
																			</td>
																			<td>
																				<span class="kt-widget11__title">Quiz</span>
																				<span class="kt-widget11__sub">Assessment of the knowledge acquired.</span>
																			</td>
																			<td>
																				<div class='dropdown dropright'>
																					<button type='button' class='btn btn-hover-info btn-elevate-hover btn-icon btn-sm btn-icon-md' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false'>
																					...
																					<div class='dropdown-menu dropdown-menu-left' x-placement='top-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);'>
																						<a class='dropdown-item' href='#'><i class="fas fa-play-circle"></i>Try</a>
																					</div>
																				</div>
																			</td>
																		</tr>
																		<tr>
																			...
																			<td>
																				<div class='dropdown dropright'>
																					...
																					<div class='dropdown-menu dropdown-menu-left' x-placement='top-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);'>
																						<a class='dropdown-item' href="/loadARresource"><i class="fas fa-qrcode"></i>Learn</a>
																					</div>
																				</div>
																			</td>
																		</tr>
...
format.raw("""-width="1" fill="none" fill-rule="evenodd">
...
"""))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  DATE: Wed Nov 13 15:01:56 CET 2019
                  SOURCE: C:/Users/Mario/Desktop/MoliereDashboard/app/views/scoursedetailscontent.scala.html
                  HASH: 36aa876b7d31caa05e3ad0847c62f020981b8e85
