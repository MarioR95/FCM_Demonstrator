...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """loadARresource""", """controllers.Application.showARcontents(request:Request)"""),
 ...
 ~~~~""",
  ...
  // @LINE:46
  private[this] lazy val controllers_Application_showARcontents17_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("loadARresource")))
  )
  private[this] lazy val controllers_Application_showARcontents17_invoker = createInvoker(
    
    (req:play.mvc.Http.Request) =>
      Application_0.showARcontents(fakeValue[play.mvc.Http.Request]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.Application",
      "showARcontents",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:46
    case controllers_Application_showARcontents17_route(params@_) =>
      call { 
        controllers_Application_showARcontents17_invoker.call(
          req => Application_0.showARcontents(req))
      }
